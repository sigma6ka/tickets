...
const Modal = ({ eventData, closeModal }) => {
  return (
      ...
      <div className="modal__content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal__box">
          <div className="modal__date">
            ...
            {formatDate(eventData.spend_date)}
          </div>
        </div>
        <div className="modal__box">
          <div className="modal__title">
            <div className="modal__title-text">{eventData.title}</div>
            <div className="modal__title-url">
              URL: <a href={eventData.url}>{eventData.url}</a>
            </div>
          </div>
        </div>
        <div className="modal__box">
          <div className="modal__venue">
            ...
            <div className="modal__venue-title">{eventData.venue.name}</div>
            <div className="modal__venue-place">
              <p>{eventData.venue.country},</p>
              <p>{eventData.venue.city}</p>
            </div>
          </div>
        </div>
        <div className="modal__box">
              ...
              <div className="modal__ticket-box">
                {eventData.tickets.map((ticket, index) => (
                  <div key={index} className="modal__ticket">
                    ...
                    <div className="modal__ticket-content">
                      Row: <span>{ticket.currency_code}</span>
                    </div>
                  </div>
                ))}
              </div>
